...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        private void Start()
        {
            RestPositionOffset = virtualCamera.transform.position;
            RestRotationOffset = virtualCamera.transform.localEulerAngles;
        ...
        void Update()
        {
            ...
            virtualCamera.transform.localPosition = posAddShake + RestPositionOffset;
            virtualCamera.transform.localEulerAngles = rotAddShake + RestRotationOffset;
